  ...
  return(
    <PopupWithForm onClose={app.closeAllPopups} isOpen={props.isOpen} onSubmit={handleSubmit} title={"Редактировать профиль"} name={"edit_profile"} button={props.button}>
      ...
      <label className="popup__label">
        <input id="info-edit-input" value={description || ""} type="text" placeholder="Укажите информацию о себе" onChange={handleChangeDescription}
               className="popup__input popup__input_type_info" name="about" minLength="2" maxLength="200"
               required/>
